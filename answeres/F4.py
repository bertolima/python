...
esfera_estrela = [n_estrelas[i] for i in range(0, esferas) if n_estrelas[i] == 1 or n_estrelas[i] == 2 or n_estrelas[i] == 3 or n_estrelas[i] == 4 or n_estrelas[i] == 5 or n_estrelas[i] == 6 or n_estrelas[i] == 7]
...
for j in range(n-1):
  for i in range(n-1):
    if esfera_estrela[i] > esfera_estrela[i + 1]:
      esfera_estrela[i], esfera_estrela[i + 1] = esfera_estrela[i + 1], esfera_estrela[i]
